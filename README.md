...
4. A red **"Delete all chats"** / **« Supprimer tous les chats »** button appears in the center of the page.
...
3. Si les 3 petits points (bouton options ⋯) n'apparaissent pas sur chaque conversation, faites un clic droit dessus puis cliquez sur **Inspecter l'élément** pour les afficher. Laissez le ouvert.
4. Un bouton rouge **"Delete all chats"** / **« Supprimer tous les chats »** apparaît au centre de la page.
